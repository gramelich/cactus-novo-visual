...
use App\Filament\Admin\Resources\PromotionResource; // Adicionado
                    ...
                    NavigationGroup::make()
                        ->items([
                            ...
                            NavigationItem::make('settings')
                                ...
                                ->label(fn(): string => 'CONFIGURAÇÕES GERAIS')
                            ...
                            NavigationItem::make('setting-spin')
                                ->icon('heroicon-o-cog-6-tooth')
                                ->label(fn(): string => 'DEFINIÇÕES DE ROLETA PREMIOS')
                            ...
                            NavigationItem::make('games-key')
                                ->icon('heroicon-o-cog-6-tooth')
                                ->label(fn(): string => 'DEFINIÇÕES DE API DE JOGOS')
                            ...
                            NavigationItem::make('gateway')
                                ->icon('heroicon-o-cog-6-tooth')
                                ->label(fn(): string => 'DEFINIÇÕES DE API DE PAGAMENTOS')
                            ...
                            NavigationItem::make('custom-layout')
                                ...
                                ->label(fn(): string => 'DEFINIÇÕES DE CSS E PIXEL')
