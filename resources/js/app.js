...
if (localStorage.getItem("token")) {
    try {
        ...
        console.error("Erro ao recuperar idioma do user:", e);
    }
}
...
app.use(i18nVue, {
    ...
    resolve: async (lang) => {
        ...
        if (langs[langPath]) {
            return await langs[langPath]();
        } else {
            console.warn(`Idioma '${lang}' não encontrado, carregando pt_BR como fallback`);
