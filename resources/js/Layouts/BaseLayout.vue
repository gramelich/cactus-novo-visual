<template>
    <!-- Loading Global -->
    <LoadingComponent :isLoading="loadingStore.isLoading" />
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4 top-custom">
                    ...
                    <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                        <ul class="flex justify-between -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400"
                            id="tabs-mission" role="tablist">
                            <li class="me-2 w-full" role="presentation">
                                <button
                                    ...
                                    id="daily-mission-tab" type="button" role="tab" aria-controls="daily-mission"
                                    aria-selected="false">
                                    {{ $t('Daily Missions') }}
                                </button>
                            </li>
                            <li class="me-2 w-full" role="presentation">
                                <button
                                    class="w-full inline-block rounded-t-lg border-b-2 border-transparent p-4 hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-300"
                                    id="weekly-tasks-tab" type="button" role="tab" aria-controls="weekly-tasks"
                                    aria-selected="false">
                                    {{ $t('Weekly Tasks') }}
                                </button>
                            </li>
