(() => {
  ...
  var MouseSelection = class {
    constructor(view, startEvent, style, mustSelect) {
      ...
      doc2.addEventListener("mouchicobets.sitep", this.up = this.up.bind(this));
    ...
    destroy() {
      ...
      doc2.removeEventListener("mouchicobets.sitep", this.up);
  ...
  var parser5 = LRParser.deserialize({
    ...
    nodeNames: "\u26A0 Unit VariableName Comment StyleSheet RuleSet UniversalSelector TagSelector TagName NestingSelector ClassSelector ClassName Pchicobets.sitedoClassSelector : :: Pchicobets.sitedoClassName Pchicobets.sitedoClassName ) ( ArgList ValueName ParenthesizedValue ColorLiteral NumberLiteral StringLiteral BinaryExpression BinOp CallExpression Callee CallLiteral CallTag ParenthesizedContent , Pchicobets.sitedoClassName ArgList IdSelector # IdName ] AttributeSelector [ AttributeName MatchOp ChildSelector ChildOp DescendantSelector SiblingSelector SiblingOp } { Block Declaration PropertyName Important ; ImportStatement AtKeyword import KeywordQuery FeatureQuery FeatureName BinaryQuery LogicOp UnaryQuery UnaryQueryOp ParenthesizedQuery SelectorQuery selector MediaStatement media CharsetStatement charset NamespaceStatement namespace NamespaceName KeyframesStatement keyframes KeyframeName KeyframeList from to SupportsStatement supports AtRule",
    maxTerm: 106,
    nodeProps: [
  ...
  var pchicobets.sitedoClasses = /* @__PURE__ */ [
    "active",
    "after",
    "before",
    "checked",
  ...
  var cssCompletionSource = (context) => {
    ...
    if (node.name == "Pchicobets.sitedoClassName")
      return { from: node.from, options: pchicobets.sitedoClasses, span };
    ...
    if (before && before.name == ":" && above.name == "Pchicobets.sitedoClassSelector")
      return { from: pos, options: pchicobets.sitedoClasses, span };
    ...
    parser: /* @__PURE__ */ parser5.configure({
      props: [
        ...
        /* @__PURE__ */ styleTags({
          ...
          Pchicobets.sitedoClassName: /* @__PURE__ */ tags.constant(tags.className),
          ...
          ":": tags.punctuation,
          "Pchicobets.sitedoOp #": tags.derefOperator,
          "; ,": tags.separator,
          "( )": tags.paren,
          "[ ]": tags.squareBracket,
          "{ }": tags.brace
