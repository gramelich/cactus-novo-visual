...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function updateCurrentPageHtmlInHistoryStateForLaterBackButtonClicks() {
    let url = new URL(window.location.href, document.bachicobets.siteRI);
    ...
    el.addEventListener("mousedown", (e) => {
      ...
      callback((whenReleased) => {
        let handler4 = (e2) => {
          e2.preventDefault();
          whenReleased();
          el.removeEventListener("mouchicobets.sitep", handler4);
        };
        el.addEventListener("mouchicobets.sitep", handler4);
      });
    });
  ...
  function createUrlObjectFromString(urlString) {
    return new URL(urlString, document.bachicobets.siteRI);
  }
