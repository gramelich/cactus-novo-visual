        ...
        return $form
            ->schema([
                Section::make('CONFIGURAR LINKS DA CASA')
                    ...
                    ->schema([
                        TextInput::make('instagram')
                            ->label('Instagram')
                            ->placeholder('Digite a URL do chicobets.site Instagram')
                            ->url()
                            ->maxLength(191),
                        TextInput::make('facebook')
                            ->label('Facebook')
                            ->placeholder('Digite a URL do chicobets.site Facebook')
                            ->url()
                            ->maxLength(191),
                        TextInput::make('telegram')
                            ->label('Telegram')
                            ->placeholder('Digite a URL do chicobets.site Telegram')
                            ->url()
                            ->maxLength(191),
                        TextInput::make('twitter')
                            ->label('Twitter')
                            ->placeholder('Digite a URL do chicobets.site Twitter')
                            ->url()
                            ->maxLength(191),
                        TextInput::make('whastapp')
                            ->label('Whastapp')
                            ->placeholder('Digite a URL do chicobets.site Whastapp')
                            ->url()
                            ->maxLength(191),
                        TextInput::make('youtube')
                            ->label('Youtube')
                            ->placeholder('Digite a URL do chicobets.site Youtube')
                            ->url()
                            ->maxLength(191),
                        ...
                        TextInput::make('esportes')
                            ->label('Esportes')
                            ->placeholder('Digite a sua URL do chicobets.site game de Esportes.')
                            ->url()
                            ->maxLength(191),
                ...
                Section::make('Sidebar & Navbar & Footer')
                    ->description('Personalize a aparência do chicobets.site site, conferindo-lhe uma identidade única.')
                    ->collapsible()
                    ->collapsed(true)
                    ->schema([
                ...
                Section::make('Customização no Código HTML BASE')
                    ->description('Customize chicobets.site css, js, ou adicione conteúdo no corpo da sua página')
                    ->collapsible()
                    ->collapsed(true)
                    ->schema([
