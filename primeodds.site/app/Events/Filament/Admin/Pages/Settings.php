            ...
            ->schema([
                ...
                Section::make('Logos')
                    ->schema([
                        ...
                        // Novos campos para banners e imagens mobile
                ...
                Section::make('Taxas')
                    ...
                    ->schema([
                        ...
                        Toggle::make('revshare_reverse')
                            ...
                            ->helperText('Esta opção possibilita que o afiliado acumule saldos negativos decorrentes das perdas geradas pelos chicobets.sites indicados.'),
    ...
    public function submit(): void
    {
        try {
            ...
            if (!empty($setting)) {
                ...
                // Tratar upload dos novos campos também
                foreach ([
                    'software_background',
                    'software_favicon',
                    'software_logo_white',
                    ...
                    'software_mobile_login',
                    'software_mobile_register',
                    'software_banner_register',
                    'software_banner_login',
                    'software_banner_afiliado',
                ] as $field) {
                    $file = $this->data[$field] ?? null;

                    if (is_array($file) || is_object($file)) {
                        if (!empty($file)) {
                            $this->data[$field] = $this->uploadFile($file);
                        }
                    }
                }
