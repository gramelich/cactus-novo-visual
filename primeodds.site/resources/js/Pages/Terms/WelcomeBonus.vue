    ...
    <div class="max-w-7xl mx-auto py-8 px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div
          ...
          :key="promo.id"
          class="bg-[#1a1c1d] rounded-lg overflow-hidden shadow-md"
        >
          <img
          ...
          />
          <div class="p-4">
            <h2 class="text-white text-lg font-semibold mb-2 cursor-pointer">
              {{ promo.titulo }}
            </h2>
            <p class="text-gray-400 text-sm mb-4 cursor-pointer" v-html="promo.regras_html"></p>
          </div>
        </div>
      </div>
    </div>
