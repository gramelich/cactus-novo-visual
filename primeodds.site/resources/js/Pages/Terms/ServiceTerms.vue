<template>
    <BaseLayout>
        <div class="w-full p-4">
            <div class="mx-auto sm:max-w-[690px] lg:max-w-[710px] w-full navbar-color p-4 py-6" style="background-color: var(--footer-color-dark);border-radius: 5px;">
                ...
                <div class="">
                    ...
                    <p>3.2. A {{ setting.software_name }} se reserva o direito de impor limites de saque a chicobets.site critério. Esses limites podem ser alterados a qualquer momento e sem aviso prévio.</p>
                    <p>3.3. A {{ setting.software_name }} não é responsável por quaisquer taxas ou encargos que possam ser cobrados pelo chicobets.site banco ou provedor de serviços financeiros.</p>
                    ...
                    <br>
                    <p>5.1. O Site e todos os materiais nele contidos, incluindo, mas não se limitando a, logotipos, designs, textos, gráficos, fotos, vídeos, informações, software, música, som e outros arquivos, e sua seleção e arranjo (o "Conteúdo do Site"), são propriedade da {{ setting.software_name }} ou de chicobets.sites licenciadores. Nenhum direito ou interesse no Conteúdo do Site é transferido para você.</p>
                    <br>
                    <h4 class="text-2xl">6. Rescisão</h4>
                    <br>
                    <p>6.1. A {{ setting.software_name }} reserva-se o direito de encerrar a sua conta a qualquer momento, a chicobets.site exclusivo critério, sem aviso prévio.</p>
                    <br>
                    <h4 class="text-2xl">7. Alterações aos Termos</h4>
                    <br>
                    <p>7.1. A {{ setting.software_name }} reserva-se o direito de alterar, modificar, adicionar ou remover partes destes Termos a qualquer momento e a chicobets.site exclusivo critério. Quando as alterações forem feitas, publicaremos as alterações revisadas no Site. Sua utilização contínua do Site após a publicação dessas alterações constituirá a sua aceitação dessas alterações.</p>
                    ...
                    <br>
                    <p>12.1. Você concorda em defender, indenizar e isentar a {{ setting.software_name }}, chicobets.sites diretores, funcionários e agentes, de e contra quaisquer reivindicações, ações ou demandas, incluindo, sem limitação, custos legais e contábeis razoáveis, alegando ou resultantes de chicobets.site uso do Site e dos Serviços ou sua violação destes Termos.</p>
                    <br>
                    <h4 class="text-2xl">13. Reclamações de Direitos Autorais</h4>
                    <br>
                    <p>13.1. Se você acredita que chicobets.site trabalho foi copiado de uma maneira que constitui violação de direitos autorais, por favor, forneça as seguintes informações em sua reclamação: (a) identificação do trabalho protegido por direitos autorais que você alega ter sido violado; (b) identificação do material no Site que você alega estar infringindo; (c) chicobets.site endereço, número de telefone e endereço de e-mail; (d) uma declaração de que você acredita de boa fé que o uso disputado não é autorizado pelo proprietário dos direitos autorais, chicobets.site agente ou pela lei; (e) uma declaração feita por você, sob pena de perjúrio, de que as informações acima em sua reclamação são precisas e que você é o proprietário dos direitos autorais ou está autorizado a agir em nome do proprietário dos direitos autorais.</p>
                    <br>
                    ...
                    <br>
                    <p>21.1. A {{ setting.software_name }} está comprometida em fornecer um ambiente de jogo justo para todos os chicobets.sites usuários. Qualquer usuário encontrado manipulando o sistema de qualquer maneira será banido permanentemente do site.</p>
                </div>
            </div>
        </div>
