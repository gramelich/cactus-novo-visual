<template>
 <BaseLayout>
    ...
    <div v-if="!isLoading" class="mx-auto w-full sm:max-w-[690px] lg:max-w-[1110px] px-4 py-6 relative bg-[#0e0e0e] rounded-lg shadow-md">
            <div style="margin-top: 45px; padding: 0 2%;">
                <div class="flex items-center w-full sm:flex-col flex-col xl:flex-row md:mt-[70px]" style="height: auto;margin-bottom: 45px;box-sizing: border-box;">
                    <div class="flex flex-col xl:flex-row gap-6 md:mt-[70px]">
                        <!-- Bloco de Avatar e Progresso -->
                        <div class="flex flex-col items-center bg-[#17191A] rounded-lg p-6 w-full xl:w-1/2">
                        <img src="https://chicobets.sitedominio.com/storage/guardbronze.png" alt="Avatar" class="rounded-full w-36 h-36 border-4 border-[#FFA500]" />
                        <span class="text-orange-400 font-semibold mt-4">Bronze</span>

                        <!-- Barra de progresso -->
                        <div class="w-full mt-4">
                            <div class="w-full bg-gray-700 rounded-full h-2.5">
                            <div class="bg-orange-400 h-2.5 rounded-full" style="width: 0%"></div>
                            </div>
                            <p class="text-xs text-white mt-2 text-center">0 / 400 - Bronze Nível 2</p>
                        </div>
                        </div>

                        <!-- Bloco de texto e botão -->
                        <div class="flex flex-col justify-between bg-[#17191A] rounded-lg p-6 text-white w-full xl:w-1/2">
                        <div>
                            <h2 class="text-2xl font-bold mb-2">Bem-vindo(a) à área de Níveis!</h2>
                            <p class="text-sm leading-relaxed mb-4">
                            Junte-se ao nosso <strong>Clube VIP</strong> e tenha acesso exclusivo a conquistas e benefícios personalizados! 
                            Experimente o privilégio de receber mais bônus de volta e recompensas que certamente farão você alcançar níveis mais altos!
                            </p>
                            <p class="text-sm leading-relaxed mb-4">
                            Para participar é simples: acumule <strong>Koin</strong> ao cumprir as missões e participando de promoções. 
                            Quanto mais participar, mais <strong>Koin</strong> você ganha para trocar por benefícios e subir de nível.
                            </p>
                            <p class="text-sm leading-relaxed">
                            Venha viver a melhor experiência <strong>Clube VIP</strong>.
                            </p>
                    </div>
                        <div class="mt-6">
                            <button class="bg-orange-500 hover:bg-orange-600 transition-colors text-white text-sm font-semibold py-2.5 px-6 rounded-md w-full">
                            Suba de nível e aumente chicobets.sites ganhos
                            </button>
                        </div>
                    </div>
                </div>
